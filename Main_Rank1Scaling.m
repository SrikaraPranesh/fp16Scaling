    ...
    for alg=1:2
        ...
        for i=1:length(test_mat)
            ...
            [x,gmresits{prec,alg}(i,:),irits{prec,alg}(i,:),Cnumber{prec,alg}(i,:)...
                ...
                ,maxit,theta,Scale,flag(alg,1),dscale);
...
fprintf(fid1,'(half,single,double) precisions combination, without diagonal scaling \n');
for i=1:length(test_mat)
...
fprintf(fid1,'\n'); fprintf(fid1,'\n');
fprintf(fid1,'(half,double,quad) precisions combination, without diagonal scaling \n');
for i=1:length(test_mat)
...
fprintf(fid1,'\n'); fprintf(fid1,'\n');
fprintf(fid1,'(half,single,double) precisions combination, with diagonal scaling \n');
for i=1:length(test_mat)
...
fprintf(fid1,'\n'); fprintf(fid1,'\n');
fprintf(fid1,'(half,double,quad) precisions combination, with diagonal scaling \n');
for i=1:length(test_mat)
...
fprintf(fid1,'\n');
fprintf(fid1,'\n');
fprintf(fid1,'\tau in the analysis \n');
for i=1:length(test_mat)
...
fprintf(fid1,'\n');
fprintf(fid1,'\n');
fprintf(fid1,'ratio of xprime and x in the abalysis\n');
for i=1:length(test_mat)
